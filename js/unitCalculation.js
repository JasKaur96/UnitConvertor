...
let units = {
    ...
    time:['Second','Hour','Day','Week','Month']
}
...
window.addEventListener("DOMContentLoaded", function(){
    ...
    function unitChange(){
        let selected_option = units[this.value] || units.area; //get select option,

        while(inputType.options.length > 0 && resultType.options.length > 0){  //remove elements.
            inputType.options.remove(0);
            resultType.options.remove(0);
        }

        //convert the seleted obj into array and create a option for each arr element.
...
function lengthCal1(option){
    switch(option){
        ...
        case "Meter-Centimeter" :
                ...
                break;
        case "Meter-Meter" :
                userResult.value = userInput.value;                        console.log(userResult.value);
                break;
...
function lengthCal2(option2){
    switch(option2){
        ...
        case "Centimeter-Kilometer":             
                ...
                console.log(userInput.value);break;
        case "Centimeter-Meter":
                userInput.value =  unitMultiply(userResult.value,100);
                console.log(userInput.value);break;
        case "Centimeter-Millimeter":
